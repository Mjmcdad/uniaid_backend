...
const initModels = async () => {
  ...
  Teacher.belongsToMany(TSection, {
    through: TTeacher,
    foreignKey: "teacherId",
    onDelete: "CASCADE",
  });
  TSection.belongsToMany(Teacher, {
    through: TTeacher,
    foreignKey: "tSectionId",
    onDelete: "CASCADE",
  });

  Teacher.belongsToMany(PSection, {
    through: PTeacher,
    foreignKey: "teacherId",
    onDelete: "CASCADE",
  });
  PSection.belongsToMany(Teacher, {
    through: PTeacher,
    foreignKey: "pSectionId",
    onDelete: "CASCADE",
  });

  Semester.belongsToMany(Subject, {
    through: SubjectOffer,
  ...
  Student.belongsToMany(SubjectOffer, {
    through: Enrollment,
    foreignKey: "studentId",
    onDelete: "CASCADE",
  });
  SubjectOffer.belongsToMany(Student, {
    through: Enrollment,
    foreignKey: "subjectOfferId",
    onDelete: "CASCADE",
  });
  ...
  StudentMark.belongsTo(Enrollment, {
    foreignKey: "enrollmentId",
    onDelete: "CASCADE",
  });
  Enrollment.hasOne(StudentMark, {
    foreignKey: "enrollmentId",
    onDelete: "CASCADE",
  });

  SubjectOffer.hasMany(Exam, {
    foreignKey: "subjectOfferId",
    onDelete: "CASCADE",
  });
  Exam.belongsTo(SubjectOffer, {
    foreignKey: "subjectOfferId",
    onDelete: "CASCADE",
  });
  ...
  SubjectOffer.hasOne(MarkSplit, {
    foreignKey: "subjectOfferId",
    onDelete: "CASCADE",
  });
  MarkSplit.belongsTo(SubjectOffer, {
    foreignKey: "subjectOfferId",
    onDelete: "CASCADE",
  });

  MarkSplit.hasMany(Assignment, {
    foreignKey: "markSplitId",
    onDelete: "CASCADE",
  });
  Assignment.belongsTo(MarkSplit, {
    foreignKey: "markSplitId",
    onDelete: "CASCADE",
  });
  ...
  SubjectOffer.hasMany(Enrollment, {
    foreignKey: "subjectOfferId",
    onDelete: "CASCADE",
  });
  Enrollment.belongsTo(SubjectOffer, {
    foreignKey: "subjectOfferId",
    onDelete: "CASCADE",
  });

  SubjectOffer.belongsTo(Subject, { foreignKey: "subjectId" });
  Subject.hasMany(SubjectOffer, {
    foreignKey: "subjectId",
    onDelete: "CASCADE",
  });

  SubjectOffer.belongsTo(Semester, { foreignKey: "semesterId" });
  Semester.hasMany(SubjectOffer, {
    foreignKey: "semesterId",
    onDelete: "CASCADE",
  });
};
